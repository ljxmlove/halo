...
public class MDLine {
  ...
  public String toString() {
    ...
    if (type.equals(MDLineType.Ordered)) {
      ...
      newLine.append("----");
    } else if (type.equals(MDLineType.Blockquote)) {
      newLine.append("> ");
      contentStr = contentStr.trim();
    } else if (type.equals(MDLineType.Code)) {
      newLine.append("``` \n");
    }
    ...
    if (type.equals(MDLineType.Code)) {
      newLine.append("\n ``` \n");
    }
  ...
  public enum MDLineType {
    Ordered, Unordered, None, Head1, Head2, Head3, HR, Blockquote, Code
  }
}
